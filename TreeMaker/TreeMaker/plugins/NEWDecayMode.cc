...
hNeutralIsoPtSumWeight1_nGoodVtx_dmf = fs->make<TProfile>(("hNeutralIsoPtSumWeight1_nGoodVtx_dmf"+prefix).c_str() ,"hNeutralIsoPtSumWeight1_nGoodVtx_dmf",200,0,200,0,400); 
  ...
  Nvtx_CombinedL = fs->make<TH1F>(("Nvtx_CombinedL"+prefix).c_str() ,"Nvtx_CombinedL",200,0,200);
  NGood_CombinedL = fs->make<TH1F>(("NGood_CombinedL"+prefix).c_str() ,"NGood_CombinedL",200,0,200);
  ...
  Nvtx_CombinedT = fs->make<TH1F>(("Nvtx_CombinedT"+prefix).c_str() ,"Nvtx_CombinedT",200,0,200);
  NGood_CombinedT = fs->make<TH1F>(("NGood_CombinedT"+prefix).c_str() ,"NGood_CombinedT",200,0,200);
